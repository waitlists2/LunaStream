        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-center items-center space-x-4">
            ...
            <a
              ...
              className="bg-[#EA4335] hover:bg-[#D33B2C] text-white p-2.5 rounded-lg shadow-md transition-all duration-200 transform hover:-translate-y-0.5 group"
              title="Email us"
            >
              <svg
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="bg-[#000000] hover:bg-[#333333] text-white p-2.5 rounded-lg shadow-md transition-all duration-200 transform hover:-translate-y-0.5 group"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="bg-[#0088CC] hover:bg-[#006699] text-white p-2.5 rounded-lg shadow-md transition-all duration-200 transform hover:-translate-y-0.5 group"
